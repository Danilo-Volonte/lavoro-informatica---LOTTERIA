...
<head>
    ...
    <style>
        ...
        /* MESSAGGI */
        .msg-success { background-color: #d1fae5; color: #065f46; padding: 12px; border-radius: 6px; margin-bottom: 20px; border-left: 4px solid #10b981; font-size: 0.9rem; }
        ...
        <div class="form-container">
            ...
            <form method="POST" action="creaLotteria.php">
                ...
                <div class="form-group">
                    ...
                    <input type="number" id="prezzoBiglietto" name="prezzoBiglietto" min="1" max="5" required placeholder="3">
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="number" id="bigliettiVincenti" name="bigliettiVincenti" min="1" required placeholder="10">
                </div>
