    ...
    <div class="container">
        ...
        <div class="profile-card">
            ...
            <div class="user-details">
                ...
                <p><strong>Data di Nascita:</strong> <?php echo date('d/m/Y', strtotime($utente['data_nascita'])); ?>
                </p>
        ...
        <div>
            ...
            <?php else: ?>
                <p
                    style="color: var(--text-light); background: var(--card-bg); padding: 20px; border-radius: 10px; box-shadow: 0 4px 15px rgba(0,0,0,0.05);">
                    Non hai ancora acquistato nessun biglietto. <a href="index.php"
                        style="color: var(--primary); font-weight: bold;">Scopri le lotterie disponibili!</a>
                </p>
            <?php endif; ?>
